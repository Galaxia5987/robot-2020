...
public class SimpleClimb extends CommandBase {
    ...
    public void initialize() {
        ...
        climber.setLeftHeight(SIMPLE_CLIMB_HEIGHT, Constants.Climber.ARBITRARY_FEEDFORWARD);
        climber.setRightHeight(SIMPLE_CLIMB_HEIGHT, Constants.Climber.ARBITRARY_FEEDFORWARD);
    }
