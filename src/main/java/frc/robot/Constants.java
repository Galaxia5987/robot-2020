...
public class Constants{
    ...
    public static class Climber {
        ...
        public static final WebConstant MODIFY_JOYSTICK_RATE = new WebConstant("climbJoystickRate", 0.2); // The factor which the value of the joystick is multiplied by to calculate the change rate.
