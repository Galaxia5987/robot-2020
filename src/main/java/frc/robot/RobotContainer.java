...
//        OI.a.whenPressed(new TurnTurret(turret, 0));
//        OI.x.whenPressed(new TurnTurret(turret, 90));
//        OI.b.whenPressed(new TurnTurret(turret, 180));
...
//        OI.x.whenPressed(new InstantCommand(() -> intake.setPosition(State.TOGGLE)));
        ...
        OI.a.whileHeld(new OuttakeBalls(conveyor, intake, 0.2, 0.5));
        OI.select.whileHeld(new FeedTurret(conveyor));
//
//        OI.a.whenPressed(new InstantCommand(() -> conveyor.openGate(true)));//0
//        OI.y.whenPressed(new InstantCommand(() -> conveyor.openGate(false)));//1

//        OI.select.whenPressed(new Instan
//        tCommand(CommandScheduler.getInstance()::cancelAll));
